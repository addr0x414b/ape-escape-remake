...
int main() {
    ...
    std::cout << "Begin creating framebuffers...\n";
    ...
    std::cout << "Successfully created all framebuffers\n";

    std::cout << "Begin creating command pool...\n";
    ...
    std::cout << "Begin creating command buffers...\n";
    ...
    std::cout << "Begin recording command buffers...\n";

    std::cout << "Begin creating semaphores...\n";
    ...
    while (!bQuit) {
        while (SDL_PollEvent(&e)) {
            ...
            if (vkQueueSubmit(graphicsQueue, 1, &submitInfo, inFlightFence) != VK_SUCCESS) {
                ...
                std::cout << "SWADHJAWDKJH AWLDUIHAW LIUDHALW IUDH\n";
            }
